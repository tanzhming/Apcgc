...
<header class="mui-bar mui-bar-nav">
    ...
    <h1 class="mui-title">平台公告</h1>
</header>
<div class="mui-content">
    <div class="news-lb">

        <ul>
        <c:forEach var="notices" items="${allnotices }" varStatus="vs">
                <li>
                    <a href="${pageContext.request.contextPath }/noticesDetail.action?NoticesID=${notices.id}&noticesTitle=${notices.noticestitle}">
                        ${notices.noticestitle }
                        <span class="mui-h5">
                        	<fmt:formatDate value="${notices.noticesdate }" pattern="yyyy/MM/dd"/>
                        </span>
                    </a>
                </li>
        </c:forEach>
